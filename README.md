...
| [Animation Desk](https://www.kdan.com/animation-desk) | FREE | A great app for creating animations on iPad. |
...
| [Bluesky](https://bsky.app/) | FREE | Open-source decentralized social media platform. |
| [CleanMyPhone](https://macpaw.com/cleanmyphone) | $ | Storage cleaner. Can free up lots of space and keep you organized. |
...
| [Delta](https://apps.apple.com/us/app/delta-game-emulator/id1048524688) | FREE | Multi-platform retro game emulator for iOS devices. |
| [Discord](https://discord.com) | FREE | Chat app that supports audio/video/text for large groups, tailored to Gaming. |
| [Duolingo](https://www.duolingo.com) | FREE | Learn a new language with fun games and exercises. |
| [FE File Explorer Pro](https://www.skyjos.com/fileexplorer/) | $ | Advanced file manager and SFTP/FTP client for iOS devices. |
| [Game Archive](https://apps.apple.com/us/app/game-archive/id1453913884) | FREE | Game list manager for iOS devices. |
| [Github](https://apps.apple.com/us/app/github/id1477376905) | FREE | Manage your Github Repos easily. |
